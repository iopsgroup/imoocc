...
"""
This modules provides GSS-API / SSPI  authentication as defined in :rfc:`4462`.
...
def GSSAuth(auth_method, gss_deleg_creds=True):
    ...
    :raise ImportError: If no GSS-API / SSPI modules could be imported.
    ...
    if _API == "MIT":
        ...
        raise ImportError("Unable to import a GSS-API / SSPI modules!")
